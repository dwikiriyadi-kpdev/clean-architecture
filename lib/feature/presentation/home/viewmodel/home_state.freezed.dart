...
mixin _$HomeState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, limit, errorMessage);

  @override
  String toString() {
    return 'HomeState(limit: $limit, errorMessage: $errorMessage)';
  }
}
...
abstract mixin class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Limit limit, String errorMessage});
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  $LimitCopyWith<$Res> get limit {
    return $LimitCopyWith<$Res>(_self.limit, (value) {
...
class _HomeState implements HomeState {
  const _HomeState({this.limit = const Limit(), this.errorMessage = ''});
